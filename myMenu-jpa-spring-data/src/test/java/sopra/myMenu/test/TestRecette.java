...
//	}
	@Test
	public void findRecetteByRisingCalories() {
	...
	List<Recette> recettesParCalories = recRepo.findRecetteByRisingCalories();
	try {
...
//
//
//	Recette recettesParNom = recRepo.findRecetteByName("couscous");
//	try {
//		Assert.assertEquals(rec1.getId(), recettesParNom.getId());
//	} finally {
//		recRepo.delete(rec1);
//		recRepo.delete(rec2);
//		recRepo.delete(rec3);
...
//	}
//	@Test
//	public void findRecetteByRisingNote() {
//		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:application-context.xml");
//		IRecetteRepository recRepo = context.getBean(IRecetteRepository.class);
//
...
//
//
//	List<Recette> recettesParNote = recRepo.findRecetteByRisingNote();
//	try {
...
//}
//	@Test
//	public void findRecetteByTypeAlimentation() {
//		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("classpath:application-context.xml");
//		IRecetteRepository recRepo = context.getBean(IRecetteRepository.class);
//
//		Recette rec1 = new Recette("couscous", "mettre les legumes et le poulet", 5, 200,3F, TypeAlimentation.HALAL);
...
//
//
//	List<Recette> recettesPartypalim = recRepo.findRecetteByTypeAlimentation(TypeAlimentation.HALAL);
//	try {
